...
const cardData: BentoCardProps[] = [
  ...
  },
  {
    color: "#060010",
    title: "HTTP Actions",
    description: "Call APIs with full request control",
    label: "Action",
  },
  {
    color: "#060010",
    title: "Workflow Orchestration",
    description: "Connect steps into reliable execution paths",
    label: "Flow",
  },
  {
    color: "#060010",
    title: "Branching Logic",
    description: "Route runs with true and false conditions",
    label: "Logic",
  },
  {
    color: "#060010",
    title: "Send Email",
    description: "Deliver notifications from workflow outcomes",
    label: "Notify",
  },
  {
    color: "#060010",
    title: "Execution Monitoring",
    description: "Track run history, status, and timing",
    label: "Observability",
  },
];
...
>(({ children, className }, ref) => (
  <div ref={ref} className={`magic-bento-beam-circle ${className ?? ""}`}>
    {children}
  </div>
));
...
const LogicCenterNode: React.FC = () => {
  const midRightRef = useRef<HTMLDivElement>(null);

  return (
    <div className="magic-bento-logic-center">
      <div className="magic-bento-logic-node-wrap">
        <Ripple className="magic-bento-logic-ripple" />
        <BeamCircle
          ref={midRightRef}
          className="magic-bento-beam-node bg-white! size-22!"
        >
          <Signpost size={40} />
        </BeamCircle>
      </div>
...
const TeamworkBeamDemo: React.FC = () => {
  ...
  const BEAM_PATH_WIDTH = 2.2;
  const BEAM_GRADIENT_START = "#ffaa40";
  const BEAM_GRADIENT_STOP = "#9c40ff";
    ...
    <div className="magic-bento-teamwork" ref={containerRef}>
      <div className="magic-bento-teamwork-layout">
        ...
        <div className="magic-bento-teamwork-row">
          ...
          <BeamCircle
            ref={hubRef}
            className="magic-bento-beam-circle-hub size-14!"
          >
            <DivineMoonIcon size={38} />
          </BeamCircle>
          <BeamCircle
            ref={midRightRef}
            className="magic-bento-beam-node bg-white! size-10!"
      ...
      <AnimatedBeam
        ...
        endYOffset={-10 + BEAM_Y_OFFSET}
        pathColor={BEAM_PATH_COLOR}
        pathOpacity={BEAM_PATH_OPACITY}
        pathWidth={BEAM_PATH_WIDTH}
        gradientStartColor={BEAM_GRADIENT_START}
        gradientStopColor={BEAM_GRADIENT_STOP}
      />
      <AnimatedBeam
        containerRef={containerRef}
        fromRef={midLeftRef}
